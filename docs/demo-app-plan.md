...
| --------------------------- | --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| App shell (all screens)     | `PageShell`                       | Banner (maintenance, dismissed for good; a scheduled deletion, until cancelled), Header, Sidebar, SidebarSection, SidebarItem, Logo/LogoMark, Avatar, MenuTrigger + Menu (workspace switcher), PageHeader + Breadcrumb, Drawer (mobile nav), ToastProvider, Tooltip, CommandPalette + Kbd (⌘K)                                                                                                                  |
