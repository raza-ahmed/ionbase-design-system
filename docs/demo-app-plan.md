...
| **Agents**                  | `DataTable`, `DestructiveConfirm` | Table (sortable headers via `useTableSort`), Pagination, Combobox/Select filters, Checkbox (bulk select), Menu, Modal, EmptyState, Toast                                      |
