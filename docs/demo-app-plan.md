...
| **Agents**                  | `DataTable`, `DestructiveConfirm` | Table (sortable headers via `useTableSort`), Pagination, Select and MultiSelect filters, TagGroup (active filters), Checkbox (bulk select), Menu, Modal, EmptyState, Toast                                    |
...
| **Settings**                | `SettingsPanel`                   | Toggle, Select, RadioGroup, CheckboxGroup, Accordion, Divider, Link, Popover                                                                                                                                  |
