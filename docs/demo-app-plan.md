...
| **Settings**                | `SettingsPanel`                   | Toggle, Select, RadioGroup, CheckboxGroup, Toggletip, Accordion, Divider, Link, Popover, ButtonGroup (save bar), CodeSnippet (API access: the CLI command, an API request, a command in the key's description)                                                                                                                                                  |
